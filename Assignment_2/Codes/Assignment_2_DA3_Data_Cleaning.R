...
getwd()
setwd("C:/Users/Rauhan Nazir/Documents/R_Codes/DA3/Assignment 2")

#Loading the data from a csv file 
toronto_raw <- read.csv("listings.csv.gz")

# Saving the data on the local machine as an RDS file for easy retrieval
saveRDS(toronto_raw,"toronto_raw.RDS")

#removing the initially stored data 
rm(list=ls())


#Finally loading the data as an RDS file 
toronto_raw <- readRDS("toronto_raw.RDS")
